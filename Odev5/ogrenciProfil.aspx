<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ogrenciProfil.aspx.cs" Inherits="Odev5.Öğrenci_Profil" %>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Öğrenci Numarası"></asp:TextBox>
